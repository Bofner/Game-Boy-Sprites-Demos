...
@ObjectData
	...
	;-------------------
	;Tile ID 1/2
		.DB 	lobyte((TONBOW_LR_GLIDE_VRAM_ABS + $00) >> 4)		;tileID
	;Object attribute flags
		.DB 	OAMF_PAL0 | $00  | $00					;objectAtr
	;----
	;Tile ID 2/2
	...
	;-------------------
	;Tile ID 1/2
		.DB 	lobyte((TONBOW_LR_FLAP_VRAM_ABS + $00) >> 4)		;tileID
	;Object attribute flags
		.DB 	OAMF_PAL0 | $00  | $00					;objectAtr
	;----
	;Tile ID 2/2
	...
	;-------------------
	;Tile ID 1/2
		.DB 	lobyte((TONBOW_LR_DASH_VRAM_ABS + $00) >> 4)		;tileID
	;Object attribute flags
		.DB 	OAMF_PAL0 | $00  | $00			;objectAtr
	;----
	;Tile ID 2/2
	...
	;Tile ID 2/2
		.DB 	lobyte(TONBOW_DIAG_DASH_VRAM_ABS >> 4)				;tileID
	;Object attribute flags
		.DB 	OAMF_PAL0 | $00  | $00					;objectAtr;Tile ID 1/2
		.DB 	lobyte((TONBOW_DIAG_DASH_VRAM_ABS + $20) >> 4)		;tileID
	;Object attribute flags
		.DB 	OAMF_PAL0 | $00  | $00					;objectAtr
	;----
	...
	;-------------------
	;Tile ID 1/2
		.DB 	lobyte((TONBOW_DIAG_GLIDE_VRAM_ABS + $00) >> 4)		;tileID
	;Object attribute flags
		.DB 	OAMF_PAL0 | $00  | $00 | $00		;objectAtr
	;----
	;Tile ID 2/2
		.DB 	lobyte(TONBOW_DIAG_GLIDE_VRAM_ABS >> 4)				;tileID
	;Object attribute flags
	...
	;-------------------
	;Tile ID 1/2
		.DB 	lobyte((TONBOW_DIAG_FLAP_VRAM_ABS + $00) >> 4)		;tileID
	;Object attribute flags
		.DB 	OAMF_PAL0 | $00  | $00 | $00		;objectAtr
	;----
	;Tile ID 2/2
	...
	;-------------------
	;Tile ID 1/2
		.DB 	lobyte((TONBOW_DIAG_DASH_VRAM_ABS + $00) >> 4)		;tileID
	;Object attribute flags
		.DB 	OAMF_PAL0 | $00  | $00 | $00		;objectAtr
	;----
	;Tile ID 2/2
...
@Tiles:
	...
	@@UpDown:
		@@@Glide:
			.INCLUDE "..\\assets\\Tonbow\\oneTiles.inc"
		@@@GlideEnd:
		@@@Flap:
			.INCLUDE "..\\assets\\Tonbow\\oneTiles.inc"
		@@@FlapEnd:
