...
*/
    ...
    ld a, LCDCF_ON | LCDCF_BGON | LCDCF_OBJOFF | LCDCF_OBJ16 | LCDCF_BG8800
    ld (rLCDC), a
...
TestRoomAssets:
	@BackgroundGB:
		@@Tiles:
			.INCLUDE "..\\assets\\TestRoom\\BG\\memMapDMGTiles.inc"
		@@TilesEnd:

		@@Map:
			.INCLUDE "..\\assets\\TestRoom\\BG\\memMapDMGMap.inc"
		@@MapEnd:
	...
	@SGBAssets:
		@@SGBPal:
			.INCLUDE "..\\assets\\TestRoom\\BG\\memMapSGBPal.inc"
		@@SGBPalEnd:

		@@SGBATR:
			.INCLUDE "..\\assets\\TestRoom\\BG\\memMapSGBBLK.inc"
		@@SGBATREnd:
